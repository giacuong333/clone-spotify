...
from .serializers import UserDisplaySerializer, UserProfileUpdateSerializer, UserCreationSerializer
...
class UserStatsView(APIView):
    ...
    def get(self, request):
        ...
        try:
            ...
            return Response({"error": "An error occurred while fetching your stats."}, status=status.HTTP_500_INTERNAL_SERVER_ERROR)
...
class AdminStatsView(APIView):
    ...
    def get(self, request):
        try:
            ...
            return Response({"error": "An error occurred while fetching statistics."}, status=status.HTTP_500_INTERNAL_SERVER_ERROR)
